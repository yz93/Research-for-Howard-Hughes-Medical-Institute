...
im1_path = 'Z:\Winter 2016\HHMI\RCP_1to1000\Mix1to1000_1_R2.tif';
...
im2_path = 'Z:\Winter 2016\HHMI\RCP_1to1000\Mix1to1000_4_R2.tif';
...
im3_path = 'Z:\Winter 2016\HHMI\RCP_1to1000\Mix1to1000_6_R2.tif';
...
for_level = [2.0, 1.3, 2.2];
for_bareopen = [6, 6, 6];

num_identified_labels = zeros(1, 3);

save_names = {'mobile_im1_data', 'mobile_im2_data', 'mobile_im3_data'};
for x = 1 : 3
...
%===========Machine Learning============
load('mobile_im1_data');
mobile_im1_data = train_data;
load('mobile_im2_data');
mobile_im2_data = train_data;
load('mobile_im3_data');
