...
im1_path = 'Z:\Winter 2016\HHMI\RCP_1to1000\1_cropped.tif';
...
im2_path = 'Z:\Winter 2016\HHMI\RCP_1to1000\2_cropped.tif';
...
im3_path = 'Z:\Winter 2016\HHMI\RCP_1to1000\3_cropped.tif';
...
save_names = {'mobile_im1_data_crop', 'mobile_im2_data_crop', 'mobile_im3_data_crop'};
for x = 1 : 3
...
%     end
    ...
    % in its PixelList matrix.
        ...
        BB(1) = BB(1) + crop_offset_x(x);
        BB(2) = BB(2) + crop_offset_y(x);
...
%===========Machine Learning============
load('mobile_im1_data_crop');
mobile_im1_data = train_data;
load('mobile_im2_data_crop');
mobile_im2_data = train_data;
load('mobile_im3_data_crop');
